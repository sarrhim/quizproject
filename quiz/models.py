...
class One_answer(models.Model):
    answer_variant=models.CharField(max_length=600, verbose_name=u'header\'s text', default=" ")
    answer_description=models.CharField(max_length=600, verbose_name=u'header\'s text', default=" ")
...
class Free_text(models.Model):
    answer_text=models.CharField(max_length=600, verbose_name=u'header\'s text', default=" ")
    quest = models.ForeignKey(Question, on_delete=models.CASCADE, related_name='FreeText')
    def __str__(self):
        return self.answer_text

class MultiChoice(models.Model):
    multi_variant=models.CharField(max_length=600, verbose_name=u'header\'s text', default=" ")
    multi_description=models.CharField(max_length=600, verbose_name=u'header\'s text', default=" ")
